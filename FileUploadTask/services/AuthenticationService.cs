...
namespace Console_DeviceCodeFlow
{
    class AuthenticationService
    {
        ...
        public static async Task<GraphServiceClient> Auth()
        {
            ...
            GraphServiceClient graphClient = await AuthenticationService.SignInAndInitializeGraphServiceClient(appConfiguration, scopes);
        ...
        public static async Task<string> SignInUserAndGetTokenUsingMSAL(PublicClientApplicationOptions configuration, string[] scopes)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public async static Task<GraphServiceClient> SignInAndInitializeGraphServiceClient(PublicClientApplicationOptions configuration, string[] scopes)
        {
